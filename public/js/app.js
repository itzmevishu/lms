    ...
    $(".hamburger").on("click", function () {
        if ("show" == $(this).data("name")) {
            ...
            if (window.location.href.indexOf("mail.html") > -1) {
                $(".toc").load("load/loadthinmailmenu", function () {
                ...
                $(".toc").load("load/loadthinmenu", function () {
                    $(".ui .dropdown").dropdown({
                        transition: "fade up",
                        on: "hover"
                    });
            ...
            if (window.location.href.indexOf("mail.html") > -1) {
                $(".toc").load("load/loadmailmenu", function () {
                ...
                $(".toc").load("load/loadsidemenu", function () {
                    $(".ui.accordion").accordion();
                    $(".logoImg").transition("tada");
                });
                $(this).data("name", "show");
...
function loadhtml() {
    if (window.location.href.indexOf("mail.html") > -1) {
        ...
        $(".navbarmenu").load("load/loadnavbar", function () {
            hamburger();
            $(".ui.dropdown").dropdown();
        });
        $("#toc").load("load/loadmobilside", function () { });
        $(".mobilenavbar").load("load/loadnavbar", function () {
            $(".ui.dropdown").dropdown({
...
function colorize() {
    var a;
    var b;
    $(".footer").load("load/loadfooter", function () {
